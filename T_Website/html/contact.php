...
<html lang="en">
    <head>
        ...
        <title>Contact | A&T ALCOHOL DELIVERY</title>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item ms-3">
                            <a class="nav-link custom-btn custom-border-btn custom-btn-bg-white btn" href="https://www.zipjob.com/blog/15-best-engineer-job-search-sites/">Explore More</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-12 me-auto mb-lg-0 mb-5">
                            ...
                            <p>A&T ALCOHOL DELIVERY is ready to serve you</p>
                            ...
                            <div class="contact-info bg-white shadow-lg">
                                ...
                                <h5 class="d-flex">
                                    ...
                                    <a href="mailto:gavangatn@company.com">
                                        info@company.com
                                    </a>
                                </h5>
                            </div>
                                ...
                                <div class="consulting-form-body">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <input type="text" name="volunteer-name" id="volunteer-name" class="form-control" placeholder="Tavonga Gavanga" required>
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-10 col-8 mx-auto">
                                        <a href="mailto:gavangatn@gmail.com">
                                        <button type="submit" class="custom-btn btn button button--atlas mt-2 ms-auto">Submit Request</button>
                                    </a>
                                    </div>
                                </div>
                            </form>
